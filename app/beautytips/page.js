...
const Page = () => {
  ...
  return (
    <div className='m-2'>
       <div className='m-12 bg-slate-200 pt-6 pl-12 pr-8 pb-6 rounded-2xl' >
...
One of our goals is to educate the gents on why grooming is important. Here are some reasons as to why it’s essential and integral for gents like you. </p>
       ...
       <div className='m-12' >
        <div onClick={handleClick4} className='cursor-pointer'>
          ...
          <p className={`${drop4 ? '' : 'hidden'}`}>Personal grooming is the cheapest and most effective way to improve your overall style and appearance without having to spend so much time and money. Taking a shower, using a shaver, and using affordable, yet essential grooming and hairstyle products for men such as GATSBY are all you need to be on top of your grooming routine. </p>
       </div>

       <div className='m-12' >
        <div onClick={handleClick5} className='cursor-pointer'>
          <h2 className=''>TAKING CARE OF YOURSELF IS THE ULTIMATE FORM OF SELF-DISCIPLINE</h2>
          <span className=''></span>
        </div>
          <p className={`${drop5 ? '' : 'hidden'}`}>Personal hygiene is not much work, but doing it on a daily basis is the real challenge to many. Taking care of yourself everyday will not only keep you smelling fresh and clean, but also improve your self-discipline and more importantly form good habits.
