...
const Page = () => {
  ...
  return (
    <div className="why-choose-us">
          <div ref={myRef} className={`why-choose-us-img ${myElementIsVisible ? 'why-img-visible' : 'why-img-fade'}`} >
            <Image src={Image4} alt='barber' className='image image4' />
          </div>
          <div ref={myRef1} className={`${myElementIsVisible1 ? 'why-choose-us_visible' : 'why-choose-us_fade'}`}>
