    ...
    <div className="bg-gray-400 py-10">
        <div className="flex flex-row mb-6">
          <div className="flex flex-col flex-grow ">
            <h2 className="mr-2 ml-6 mt-6 font text-slate-800 font-bold font-raleway leading-5 lg:text-xl">Location</h2>
          ...
          <div className="ml-6 mt-6 mr-4">
            <h2 className="text-s text-slate-800 font-bold font-raleway leading-5 lg:text-xl">Contact Information</h2>
